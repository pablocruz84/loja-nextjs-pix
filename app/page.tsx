 ...
 // =========================
  ...
  useEffect(() => {
    ...
    const intervalo = setInterval(async () => {
      try {
        console.log('⏱️ Verificando pagamento no PagBank...')

        // Consulta DIRETA no PagBank
  ...
  const gerarPix = async () => {
    ...
    try {
      ...
      let cliente = await buscarClientePorCPF(dadosCliente.cpf) as any
      if (!cliente) {
        console.log('Cliente não encontrado, criando novo...')
        cliente = await criarCliente(dadosCliente as any) as any
      }
